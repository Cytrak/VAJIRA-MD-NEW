...
global.owner = process.env.OWNER_NUMBER  || '254715155196' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=2M1w1AbC#orh18EQlKaacXNaHjGdvcRtQTSFzW2heGzJtFl9zPc8' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "254715155196" : process.env.MODERATORS ,    
